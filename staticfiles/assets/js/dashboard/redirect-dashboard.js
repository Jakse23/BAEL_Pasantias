...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function getCounters(systemType) {
        try {
            // Se mantiene el prefijo /home/ según tus APIs de urls.py
        ...
        var html = `
            <div>
                ...
                <div class="aircraft-cards-container">
                    <div class="aircraft-card" onclick="window.location.href='/home/flota/transporte/c130/dashboard/'" style="cursor: pointer;">
